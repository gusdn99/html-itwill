...
//	@Test
	public void testSave() {
		...
		// insert 쿼리 실행: save() 사용. 엔터티 클래스(Post) 타입으로 리턴. 엔터티 객체의 @Id로 설정된 필드가 null인 경우.
		postRepo.save(entity); // Post entity = postRepo.save(entity); 이렇게 객체를 만들지 않아도 자동으로 저장해줌.
...
//	@Test
	public void testUpdate() {
		...
		entity.update("혀누혀누혀", "gusdngu"); // 여기서의 값이 DB에 저장되어 있는 값이랑 동일하면 update 쿼리문이 실행 안 됨.
...
//	@Test
	public void testDelete() {
		postRepo.deleteById(1L); // deleteById(): void 타입으로 리턴.
